    ...
    return (
        <div className="container">
            {[...Array(64)].map((e, i) => {
                ...
                return (
                    <Square onClick={handleSquareClick} index={i} mode={'setup'} file={file} rank={rank} />
                );
            })}
        </div>
    );
    ...
    if (props.mode == 'setup') {
        ...
        if (props.rank == 8 || props.rank == 1) {
            if (props.file == 'A' || props.file == 'H')
                return <div className={squareColor}><Rook color={color}/></div>
            else if (props.file == 'B' || props.file == 'G')
                return <div className={squareColor}><Knight color={color} /></div>
            else if (props.file == 'C' || props.file == 'F')
                return <div className={squareColor}><Bishop color={color}/></div>
            else if (props.file == 'D')
                return <div className={squareColor}><Queen color={color}/></div>
            else if (props.file == 'E')
                return <div className={squareColor}><King color={color}/></div>
        } else if (props.rank == 7 || props.rank == 2) {
            color = props.rank == 7 ? "black" : "white"
            return <div className={squareColor}><Pawn color={color}/></div>
        } else {
            return <div className={squareColor} onClick={props.onClick}></div>
        }
    }
}
